# slightly modified from https://github.com/nix-community/home-manager/issues/1341#issuecomment-1870352014
	...
	for app_path in "${apps[@]}"; do
		if [ -d "$app_path" ]; then
			...
			if [ -n "$current_dock_item" ]; then
				...
				# The app is not in the Dock; you might choose to add it or do nothing. next line left for debugging
